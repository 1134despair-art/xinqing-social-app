...
### SDK 导入
1. 下载并解压 iOS SDK 压缩包，压缩包中包含 Demo 和 SDK,其中QCloudOneSentence.xcframework为一句话识别framework包；VoiceCommon.framework为语音SDK通用组件framework包
2. XcodeFile > Add Files to "Your Project"，在弹出 Panel 选中所下载SDK包 QCloudOneSentence.xcframework和VoiceCommon.framework > Add（选中“Copy items if needed”）。
...
- (void)recognizeWithAudioData {
   ...
   // 指定语音数据 语音数据格式 识别引擎
   // 支持的格式以API文档为准，见https://cloud.tencent.com/document/product/1093/35646
